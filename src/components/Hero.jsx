...
function Hero() {
  return (
   <section className="relative overflow-hidden flex flex-col items-center justify-center text-center min-h-screen pt-12 px-6 bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950">
    <div className="absolute top-20 left-20 w-72 h-72 rounded-full bg-cyan-500/40 blur-2xl animate-floatGlow"></div>
      <div className="absolute bottom-20 right-20 w-80 h-80 rounded-full bg-indigo-500/30 blur-2xl animate-floatGlow"></div>
       <div className="absolute top-1/2 left-1/2 w-64 h-64 rounded-full bg-purple-500/20 blur-2xl animate-floatGlow"></div>
